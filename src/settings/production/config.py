...
class ProductionConfig(BaseConfig):
    """Default production env. config for FastAPI
    ...
    """
    PLATFORM: str = 'Продуктовая конфигурация'
    
    APP_PORT: int = env('APP_PORT', default=8000, parse_default=int)

    DEVELOP: bool = env('DEVELOP', default=False, parse_default=bool)
    DEBUG: bool = env('DEBUG', default=False, parse_default=bool)      # TODO logging
